package com.ez08.compass.ui.market.tablayout;
...
class SlidingTabStrip extends LinearLayout {
    ...
    public static final int DEFAULT_SELECTED_INDICATOR_COLOR = Color.RED;
    ...
    SlidingTabStrip(Context context, AttributeSet attrs) {
        ...
        context.getTheme().resolveAttribute(R.attr.main_main_color, outValue, true);
