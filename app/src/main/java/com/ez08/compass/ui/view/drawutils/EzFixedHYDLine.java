...
public class EzFixedHYDLine extends EzDrawCharBase {
	...
	public void draw(Canvas canvas, CGPoint position) {
		...
		if(values==null||position==null){
		 ...
		 y12 = (float) ((mHighestData - 12.3f) * heightScale) + startY;
		 y4 = (float) ((mHighestData - 4f) * heightScale) + startY;
		...
		Paint paint3 =  newPaint(Color.parseColor("#09C60C")); //green
		Paint paint4 = newPaint(Color.GRAY);
		paint4.setPathEffect(pathEffect);

//		Paint paintText = newPaint(titleColor);
//		paintText.setTextSize(40);
		...
		if(y12 > startY) {
			canvas.drawLine(0, y12, width, y12, paint4);
			canvas.drawText(12.3+"",0,y12,paintText);
		}

		canvas.drawText("4.0",2,y4,paintText);
		canvas.drawLine(0, y4, width, y4, paint4);
			...
			if (i == 0) {
				...
				if (previousValue >= 12.3) {
					if (value >= 12.3) {
						...
						CGPoint point12 = get12WithPrevious(previousPoint,point,y12);
						points.add(point12);
						CGPoint point4 = get12WithPrevious(point12,point,y4);
						points.add(point4);
						points.add(point);
					}
					...
					if (value >= 12.3) {
						...
						CGPoint point4 = get12WithPrevious(previousPoint,point,y4);
						points.add(point4);
						points.add(point);
					}
				} else {
					if (value >= 12.3) {
						CGPoint point4 = get12WithPrevious(previousPoint,point,y4);
						points.add(point4);
						CGPoint point12 = get12WithPrevious(point4,point,y12);
						points.add(point12);
						points.add(point);
					} else if (value >= 4) {
						CGPoint point4 = get12WithPrevious(previousPoint,point,y4);
